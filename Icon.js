...
const IconTypes = {
  FAR: Platform.OS === 'ios' ? 'FontAwesome5Free-Regular' : 'fa-regular-400',
  FAS: Platform.OS === 'ios' ? 'FontAwesome5Free-Solid' : 'fa-solid-900',
  FAB: Platform.OS === 'ios' ? 'FontAwesome5Brands-Regular' : 'fa-brands-400'
}
